...
public:
    // The code below originates from the FHECKKSRNS::EvalBootstrapSetup function,
    // but we only perform the precomputations needed for the EvalSlotsToCoeffs function.
